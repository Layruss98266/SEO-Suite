...
USE_CASES = {
    "crawlability": {
        ...
        "color": "#6366F1",
        "bg": "#EEF2FF",
        "desc": "robots.txt · HTTP status · redirects · canonical · meta robots · broken links · sitemaps · hreflang · TTFB",
        "requires": None,
        "group": "Technical",
    },
    "on_page": {
        ...
        "color": "#0EA5E9",
        "bg": "#F0F9FF",
        "desc": "Title · meta description · headings · image alt · schema · OG tags · readability · word count",
        "requires": None,
        "group": "Technical",
    },
    "site_health": {
        ...
        "color": "#14B8A6",
        "bg": "#F0FDFA",
        "desc": "SSL · HTTPS · mixed content · domain age · security headers · SPF · DMARC · MX · favicon",
        "requires": None,
        "group": "Technical",
    },
    "performance": {
        ...
        "color": "#F59E0B",
        "bg": "#FFFBEB",
        "desc": "PageSpeed · Core Web Vitals · LCP · CLS · FCP · INP · mobile vs desktop · GSC URL inspection",
